              ...
              <ul class="ta-divide">
                <?php foreach ($expiringDocs as $doc): ?>
                  <li class="py-3 flex items-center justify-between gap-3">
                    ...
                    <span class="ta-badge badge badge-warning shrink-0">Baharui Segera</span>
                  </li>
                <?php endforeach; ?>
              </ul>
            <?php endif; ?>
            ...
            <ul class="ta-divide">
              <?php foreach ($drivers as $d): ?>
                ...
                <li class="py-3 flex items-center justify-between gap-3">
                  ...
                  <span class="ta-badge shrink-0 <?= $d['status'] === 'Available' ? 'badge badge-success' : ($d['status'] === 'Leave' ? 'badge badge-warning' : 'badge badge-ghost') ?>">
