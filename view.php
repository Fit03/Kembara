              ...
              <?php if (!empty($b['passenger_memo_path'])): ?>
                  <div class="mt-3 p-4 rounded-xl border flex items-center justify-between" style="border-color: var(--ta-border); background: var(--ta-canvas);">
                      ...
                      <div class="flex items-center gap-2">
                          <a href="<?= htmlspecialchars($b['passenger_memo_path']) ?>" target="_blank" class="btn btn-sm btn-outline gap-1.5">
                          ...
                          <a href="<?= htmlspecialchars($b['passenger_memo_path']) ?>" download class="btn btn-sm text-white border-0 gap-1.5" style="background: var(--ta-brand);">
